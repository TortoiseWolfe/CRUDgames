...
export const FooterSection = forwardRef<HTMLElement, FooterSectionProps>(
  (
    ...
    if (variant === 'minimal') {
      return (
        <footer ref={ref} className={cn('bg-muted text-muted-foreground py-8', className)}>
    ...
    if (variant === 'centered') {
      return (
        <footer ref={ref} className={cn('bg-muted text-muted-foreground py-16', className)}>
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h3 className="text-2xl font-bold text-foreground mb-4">
                <Link href="https://crudgames.com" className="hover:text-primary transition-colors">
                  {companyName}
                </Link>
              </h3>
              {companyDescription && (
                <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">{companyDescription}</p>
              )}
                  ...
                  {socialLinks.map((social, index) => {
                    ...
                    return (
                      <a
                        ...
                        rel="noopener noreferrer"
                        aria-label={social.label || social.platform}
                        className="bg-background p-3 rounded-full hover:bg-primary/20 transition-colors"
                      >
                        <Icon className="h-5 w-5" />
                      </a>
                    );
                ...
                <div className="lg:col-span-3">
                  ...
                  <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 bg-input border border-border rounded-lg focus:outline-none focus:border-primary text-foreground placeholder-muted-foreground"
                    />
                    ...
                    return (
                      <a
                        ...
                        className={cn(
                          'transition-colors',
                          variant === 'modern' 
                            ? 'bg-background p-2 rounded-lg hover:bg-primary/20'
